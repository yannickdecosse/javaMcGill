...
public class Polynomial2
{
 ...
 /**
   ...
   */
   public Polynomial2 add(Polynomial2 poly)
   {
      Polynomial2 res = clone();
   ...
   public Polynomial2 clone()
   {
      Polynomial2 res = new Polynomial2();
   ...
   public boolean equals(Polynomial2 poly)
   {
      Monomial tmp1 = head;
 ...
 /**
   ...
   *  The method does not change the original polynomial.
   */
   public Polynomial2 multiply(double num)
   {
      Polynomial2 res = clone();
 ...
 /**
   ...
   */
   ...
   public static void main(String[] args)
   {
      ...
      Polynomial2 third = first.add(second);
      ...
      Polynomial2 fourth = first.multiply(0.2);
      System.out.println( fourth );
      System.out.println( first );
      System.out.println( );

      System.out.println( "differentiate first" );
      Polynomial2 diff = first.diff();
